    ...
    float hdrPaperWhiteNits)
{
    ...
    paramData.saturation = saturation;
    paramData.brightness = brightness;
    paramData.contrast = contrast;
    paramData.hdrBoost = hdrBoost;
    paramData.hdrOutputEnabled = hdrOutputEnabled ? 1.0f : 0.0f;
    paramData.hdrWhiteScale = max(0.1f, hdrPaperWhiteNits / 80.0f);
